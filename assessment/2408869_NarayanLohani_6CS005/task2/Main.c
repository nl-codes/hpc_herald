 ...
 * using OpenMP for parallelism, and writes the results to "results.txt".
 *
 * The code is modularized into smaller functions for clarity and maintainability.
 * Each function is documented, and in-line comments are provided where necessary.
 */
